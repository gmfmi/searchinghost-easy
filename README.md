...
```html
<script src="https://cdn.jsdelivr.net/gh/gmfmi/searchinghost-easy@1.0.1/dist/searchinghost-easy-basic.js"></script>
<script>
...
```html
<script src="https://cdn.jsdelivr.net/gh/gmfmi/searchinghost-easy@1.0.1/dist/searchinghost-easy-backpack.js"></script>
<script>
    new SearchinGhostEasy({
        contentApiKey: '<CONTENT_API_KEY>'
    });
